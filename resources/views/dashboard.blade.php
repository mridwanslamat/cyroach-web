...
<div class="fixed inset-0 bg-black/80 hidden items-center justify-center z-50 p-4" id="modal">
    <div class="cy-card w-full max-w-4xl overflow-hidden shadow-2xl" style="border-color:var(--border-accent);">
        ...
        {{-- Modal Body --}}
        <div class="p-5 grid gap-4" style="grid-template-columns:220px 1fr 220px;height:420px;">

            {{-- KOLOM 1: Thermal — full height --}}
            <div class="flex flex-col gap-2 h-full">
                <div class="text-xs cyroach-muted uppercase tracking-widest shrink-0" style="font-family:var(--font-mono);font-size:10px;">Kamera Thermal</div>
                <div class="rounded-lg overflow-hidden border cyroach-border flex-1" style="position:relative;">
                    <canvas id="modal-canvas" style="position:absolute;top:0;left:0;width:100%;height:100%;display:block;"></canvas>
                </div>
            </div>
            ...
            <div class="flex flex-col gap-2 h-full overflow-y-auto">
                ...
                <div class="shrink-0">
                    ...
                    <div class="grid grid-cols-3 gap-1.5">
                        <div class="cy-card-raised p-2 text-center overflow-hidden">
                            <div class="text-xs cyroach-muted mb-0.5" style="font-size:9px;">P</div>
                            <div class="font-semibold cyroach-text truncate" style="font-family:var(--font-mono);font-size:11px;" id="modal-pitch">—</div>
                        </div>
                        <div class="cy-card-raised p-2 text-center overflow-hidden">
                            <div class="text-xs cyroach-muted mb-0.5" style="font-size:9px;">R</div>
                            <div class="font-semibold cyroach-text truncate" style="font-family:var(--font-mono);font-size:11px;" id="modal-roll">—</div>
                        </div>
                        <div class="cy-card-raised p-2 text-center overflow-hidden">
                            <div class="text-xs cyroach-muted mb-0.5" style="font-size:9px;">Y</div>
                            <div class="font-semibold cyroach-text truncate" style="font-family:var(--font-mono);font-size:11px;" id="modal-yaw">—</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="cy-card-raised p-2.5 shrink-0">
            ...
            {{-- KOLOM 3: Trajectory — full height --}}
            <div class="flex flex-col gap-2 h-full">
                <div class="text-xs cyroach-muted uppercase tracking-widest shrink-0" style="font-family:var(--font-mono);font-size:10px;">Trajectory Map</div>
                <div class="rounded-lg border cyroach-border overflow-hidden flex-1" style="position:relative;">
